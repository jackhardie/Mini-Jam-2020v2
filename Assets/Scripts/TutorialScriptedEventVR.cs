...
public class TutorialScriptedEventVR : CutSceneScriptedEvent {
    OVRPlayerController fpsController;
    [SerializeField]
    ...
    private void Start() {
        ...
        fpsController = player.GetComponent<OVRPlayerController>();
    }
    ...
    private void Update() {
        if (OVRInput.GetDown(OVRInput.RawButton.A) && !flashLightOn && eventTriggered && promptActive) flashLightOn = true;
